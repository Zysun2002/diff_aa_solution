...
output_path = Path("results/low_res_two_circles_better_init")
...
center_pred_1 = torch.tensor([10.0 / canvas_size , 10.0 / canvas_size], requires_grad=True)
...
radius_pred_2 = torch.tensor(8.0 / canvas_size, requires_grad=True)
center_pred_2 = torch.tensor([26.0 / canvas_size , 30.0 / canvas_size], requires_grad=True)
